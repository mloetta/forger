...
export default function createApplicationCommand<
  const TOptions extends ApplicationCommandOptions,
>(command: ApplicationCommand<TOptions>): void {
  bot.commands.set(command.name, command as ApplicationCommand);
}

export interface ApplicationCommand<
  TOptions extends ApplicationCommandOptions = ApplicationCommandOptions,
...
export type GetApplicationCommandOptions<T extends ApplicationCommandOptions> =
  T extends ApplicationCommandOptions
...
type ResolvedValues = ParsedInteractionOption<
  ExtractDesiredProps<Bot>,
  ExtractDesiredBehavior<Bot>
>[string];
