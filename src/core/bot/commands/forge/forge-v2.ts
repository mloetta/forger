  ...
  async run(bot, interaction, options) {
        ...
        components: [
          {
            ...
            component: {
              ...
              placeholder: 'Type down the amount. Only numbers are allowed.',
    ...
    handlers.set('view-more-options', async (i) => {
      ...
      await i.respond({
        ...
        components: [
          ...
          {
            type: MessageComponentTypes.Label,
            label: 'Select an achievement for the forge.',
            component: {
              type: MessageComponentTypes.StringSelect,
          ...
          {
            type: MessageComponentTypes.Label,
            label: 'Select a stage for the achievement.',
            component: {
              type: MessageComponentTypes.TextInput,
              customId: 'achievement-stage',
              placeholder: 'Type down the stage. Use numbers from 1 to 5.',
              style: TextStyles.Short,
              required: false,
            },
          },
    ...
    handlers.set('select-category', async (i) => {
      ...
      data.equipmentRuneSlots =
        data.equipmentType === 'Weapon' ? equipment.weapon.rune_slots : equipment.armor.pieces[0].rune_slots;
            ...
            components: [
              ...
              },
              {
                ...
                accessory: {
                  ...
                  media: {
                    url: data.equipmentType === 'Weapon' ? equipment.weapon.image : equipment.armor.pieces[0].image,
                  },
                },
              },
              {
              ...
              ...((
                data.equipmentType === 'Weapon'
                  ? equipment.weapon.rune_slots >= 1
                  : equipment.armor.pieces[0].rune_slots >= 1
              )
                ? ([
                    {
                      type: MessageComponentTypes.Separator,
        ...
        components: [
          {
            ...
            component: {
              ...
              placeholder: 'Type down the forge quality. Use numbers from 0 to 100.',
              style: TextStyles.Short,
              required: false,
            },
          },
          {
            ...
            component: {
              ...
              placeholder: 'Type down the enhancement level. Use numbers from 0 to 9.',
              style: TextStyles.Short,
              required: false,
            },
          },
          ...
          ...(rune.primary_traits?.flatMap((trait: any) => {
            ...
            return rangeFields.map((field) => ({
              ...
              component: {
                ...
                placeholder: `Type down the value. Use numbers from ${trait[field].min} to ${trait[field].max}.`,
                style: TextStyles.Short,
                required: true,
              },
            }));
            ...
            ? ['chance_range', 'cooldown_range']
                ...
                .map((field) => ({
                  ...
                  component: {
                    ...
                    placeholder: `Type down the value. Use numbers from ${rune.proc[field].min} to ${rune.proc[field].max}.`,
                    style: TextStyles.Short,
                    required: true,
                  },
                }))
        ...
        components: [
          ...
          },
          {
            ...
            component: {
              ...
              placeholder: 'Type down the value. Only numbers are allowed.',
              style: TextStyles.Short,
              required: true,
            },
          },
